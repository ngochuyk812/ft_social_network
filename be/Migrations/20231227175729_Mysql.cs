        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Password = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    RefeshToken = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LikeTypeId = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomPostHome", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomPostHome_LikeType_LikeTypeId",
                        column: x => x.LikeTypeId,
                        principalTable: "LikeType",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CustomPostHome_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserAcceptId = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Friend_User_UserAcceptId",
                        column: x => x.UserAcceptId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Friend_User_UserRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdObj = table.Column<int>(type: "int", nullable: false),
                    Type = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MediaMessage", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MediaMessage_Message_MessageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MediaPost_CustomPostHome_PostId",
                        column: x => x.PostId,
                        principalTable: "CustomPostHome",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MediaPost_Post_PostId",
                        column: x => x.PostId,
                        principalTable: "Post",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MediaComment_Comment_CommentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomPostHome_LikeTypeId",
                table: "CustomPostHome",
                column: "LikeTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomPostHome_UserId",
                table: "CustomPostHome",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Friend_UserAcceptId",
                table: "Friend",
                column: "UserAcceptId");

            migrationBuilder.CreateIndex(
                name: "IX_Friend_UserRequestId",
                table: "Friend",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaComment_CommentId",
                table: "MediaComment",
                column: "CommentId");

            migrationBuilder.CreateIndex(
                name: "IX_MediaMessage_MessageId",
                table: "MediaMessage",
                column: "MessageId");

            migrationBuilder.CreateIndex(
                name: "IX_MediaPost_PostId",
                table: "MediaPost",
                column: "PostId");
